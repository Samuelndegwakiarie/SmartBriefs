...
<<<<<<< HEAD
                    ...
                    <x-nav-link :href="route('briefs.create')" :active="request()->routeIs('briefs.create')">
                        {{ __('Create New') }}
                    </x-nav-link>
...
<<<<<<< HEAD
            ...
            <x-responsive-nav-link :href="route('briefs.create')" :active="request()->routeIs('briefs.create')">
                {{ __('Create New') }}
            </x-responsive-nav-link>
             @if(Auth::user()->is_admin)
